...
<CardGroup cols={2}>
  ...
  <Card title="Run and fund" href="/workflows/running-and-funding">
    App navigation, which wallet to fund on which chain, and workflow checklist.
  </Card>
...
Product screenshots belong under `docs/images/product/` (see that folder for filenames). The [GitHub README](https://github.com/Bleyle823/Graphitti/blob/main/README.md) lists integrations, live runs, and workflow templates in one place.
