...
- **exact** scheme on `eip155:5042` (Arc Testnet listings use `eip155:5042002`)
- Asset Arc USDC `0x3600000000000000000000000000000000000000`
- `extra.name` is `GatewayWalletBatched`
- `extra.verifyingContract` is the Gateway Wallet `0x77777777Dcc4d5A8B6E418Fd04D8997ef11000eE` (testnet `0x0077777d7EBA4688BDeF3E311b846F25870A19B9`)
