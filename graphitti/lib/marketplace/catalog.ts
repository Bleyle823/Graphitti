...
export const MARKETPLACE_CATALOG: Record<string, CatalogListingMeta> = {
  ...
  "Policy-gated contractor payroll": {
    slug: "policy-gated-contractor-payroll",
    category: "privy",
    chain: "base-sepolia",
    workflowType: "write",
    priceUsdcPerCall: "0",
  ...
  "Quorum vendor bill": {
    slug: "quorum-vendor-bill",
    category: "privy",
    chain: "base-sepolia",
    workflowType: "write",
    priceUsdcPerCall: "0",
  },
  "Fund and park idle cash": {
    slug: "fund-and-park-idle-cash",
    category: "privy",
    chain: "base-sepolia",
    workflowType: "write",
    priceUsdcPerCall: "0",
  },
  "Inbound balance webhook sweep": {
    slug: "inbound-balance-webhook-sweep",
    category: "privy",
    chain: "base-sepolia",
    workflowType: "write",
    priceUsdcPerCall: "0",
  },
  "Stripe invoice then org payout": {
    slug: "stripe-invoice-then-org-payout",
    category: "privy",
    chain: "base-sepolia",
    workflowType: "write",
    priceUsdcPerCall: "0",
  ...
  "Inbound whale sweep": {
    slug: "inbound-whale-sweep",
    category: "privy",
    chain: "base-sepolia",
    workflowType: "write",
    priceUsdcPerCall: "0",
  },
  "Vendor bill with Linear ticket": {
    slug: "vendor-bill-with-linear-ticket",
    category: "privy",
    chain: "base-sepolia",
    workflowType: "write",
    priceUsdcPerCall: "0",
  },
  "Cross-chain settle then pay vendor": {
    slug: "cross-chain-settle-then-pay-vendor",
    category: "circle",
    chain: "base-sepolia",
    workflowType: "write",
    priceUsdcPerCall: "0",
  },
  "Idle USDC quote then rebalance": {
    slug: "idle-usdc-quote-then-rebalance",
    category: "privy",
    chain: "base-sepolia",
    workflowType: "write",
    priceUsdcPerCall: "0",
  },
  "Safe pending cover from org": {
    slug: "safe-pending-cover-from-org",
    category: "privy",
    chain: "base-sepolia",
    workflowType: "write",
    priceUsdcPerCall: "0",
  ...
  "Payroll batch with intent fallback": {
    slug: "payroll-batch-with-intent-fallback",
    category: "privy",
    chain: "base-sepolia",
    workflowType: "write",
    priceUsdcPerCall: "0",
