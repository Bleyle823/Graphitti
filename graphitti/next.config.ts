...
const nextConfig: NextConfig = {
  ...
  turbopack: {
    ...
    resolveAlias: {
      ...
      tls: { browser: emptyStub },
      http: { browser: emptyStub },
      https: { browser: emptyStub },
      crypto: { browser: emptyStub },
      perf_hooks: { browser: emptyStub },
      dns: { browser: emptyStub },
      dgram: { browser: emptyStub },
      child_process: { browser: emptyStub },
    },
  },
  images: {
