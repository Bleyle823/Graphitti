...
const fantasyPremierLeaguePlugin: IntegrationPlugin = {
  ...
  actions: [
    ...
    },
    {
      ...
      label: "Rank top two",
      description:
        "Sort classic league standings by gameweek score and map the top two to roster payout wallets",
      category: "Fantasy Premier League",
      stepFunction: "rankTopTwoStep",
      stepImportPath: "rank-top-two",
      outputFields: [
        { field: "ready", description: "Whether at least one prize wallet is mapped" },
        { field: "totalPrizeUsdc", description: "Sum of mapped 1st and 2nd prizes" },
        { field: "first", description: "First place team and payout" },
        { field: "second", description: "Second place team and payout" },
        { field: "ranking", description: "Full ranked list" },
        { field: "gameweekId", description: "Gameweek id passed through" },
        { field: "leagueId", description: "League id passed through" },
      ],
      configFields: [
        {
          key: "standings",
          label: "Standings results (JSON array)",
          type: "template-textarea",
          placeholder: "{{@fpl-standings:Get League Standings.standings.results}}",
          required: true,
          rows: 3,
        },
        {
          key: "roster",
          label: "Roster (JSON array)",
          type: "template-textarea",
          placeholder:
            '[{"team":"Team A","manager":"Alice","address":"0x..."}]',
          required: true,
          rows: 6,
        },
        {
          key: "firstPrizeUsdc",
          label: "1st prize (USDC)",
          type: "template-input",
          placeholder: "5",
          example: "5",
        },
        ...
        },
        {
          ...
          label: "Gameweek ID",
          type: "template-input",
          placeholder: "{{@fpl-prev-gw:Get Previous Gameweek.events.0.id}}",
        },
        {
          key: "gameweekName",
          label: "Gameweek name",
          type: "template-input",
          placeholder: "{{@fpl-prev-gw:Get Previous Gameweek.events.0.name}}",
        },
        {
          key: "leagueId",
          label: "League ID",
          type: "template-input",
          placeholder: "{{@fpl-standings:Get League Standings.league.id}}",
        },
      ],
    },
    {
